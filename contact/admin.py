...
class ContactAdmin(admin.ModelAdmin): #herda da classe de admin, devo atribuir ela no admin do django#cria no painel admin o contatos
    list_display = 'id', 'first_name', 'last_name', 'phone', 'email' #consigo mostrar do jeito que eu quiser esse padrão de ordenação
    ...
    list_display_links = 'id', 'first_name' #permite que você escolha quais campos contenham o link para acesso de editar os dados